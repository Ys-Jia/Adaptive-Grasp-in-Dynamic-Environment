...
convgru_encoder_params = [
    ...
    [
        CGRU_cell(shape=(64, 64), input_channels=16, filter_size=5, num_features=64, seq_len=3),
        CGRU_cell(shape=(32, 32), input_channels=64, filter_size=5, num_features=96, seq_len=3),
        CGRU_cell(shape=(16, 16), input_channels=96, filter_size=5, num_features=96, seq_len=3)
    ]
]
...
convgru_decoder_params = [
    ...
    [
        CGRU_cell(shape=(16, 16), input_channels=96, filter_size=5, num_features=96, seq_len=1),
        CGRU_cell(shape=(32, 32), input_channels=96, filter_size=5, num_features=96, seq_len=1),
        CGRU_cell(shape=(64, 64), input_channels=96, filter_size=5, num_features=64, seq_len=1),
    ]
]