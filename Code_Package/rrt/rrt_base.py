...
from rrt.geometry import steer
...
class RRTBase(object):
    ...
    def get_path(self):
        ...
        if self.can_connect_to_goal(0):
            ...
            return True, self.reconstruct_path(0, self.x_init, self.x_goal)
        else:
            # print("Could not connect to goal")
            x_nearest = self.get_nearest(0, self.x_goal)
            return False, self.reconstruct_path(0, self.x_init, x_nearest)
